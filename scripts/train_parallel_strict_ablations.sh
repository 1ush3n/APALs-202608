...
${PYTHON} train.py   experiment=reschedule_task_delay_r5_operation_only_strict   train.batch_size=32   train.num_envs=2   hardware.num_envs=2   hardware.worker_pointer_v2_fast_default_num_envs=2   reschedule_task_delay.async_eval_worker_count=1   reschedule_task_delay.async_eval_queue_capacity=2   train.max_episodes=60   seed=42   reschedule_task_delay.reschedule_baseline_identity_conditioning=false   > logs/train_operation_only_strict.log 2>&1 &
PID_OP_ONLY=$!

echo ">>> Launching [2/3] Operation+Station Strict in background..."
${PYTHON} train.py   experiment=reschedule_task_delay_r5_operation_station_strict   train.batch_size=32   train.num_envs=2   hardware.num_envs=2   hardware.worker_pointer_v2_fast_default_num_envs=2   reschedule_task_delay.async_eval_worker_count=1   reschedule_task_delay.async_eval_queue_capacity=2   train.max_episodes=60   seed=42   reschedule_task_delay.reschedule_baseline_identity_conditioning=false   > logs/train_operation_station_strict.log 2>&1 &
PID_OP_STATION=$!

echo ">>> Launching [3/3] Homogeneous GraphSAGE Strict in background..."
${PYTHON} train.py   experiment=reschedule_task_delay_r5_homogeneous_graphsage_strict   train.batch_size=32   train.num_envs=2   hardware.num_envs=2   hardware.worker_pointer_v2_fast_default_num_envs=2   reschedule_task_delay.async_eval_worker_count=1   reschedule_task_delay.async_eval_queue_capacity=2   train.max_episodes=60   seed=42   reschedule_task_delay.reschedule_baseline_identity_conditioning=false   > logs/train_homogeneous_graphsage_strict.log 2>&1 &
PID_GRAPHSAGE=$!
